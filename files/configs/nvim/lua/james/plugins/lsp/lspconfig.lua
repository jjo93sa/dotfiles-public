return {
	...
	config = function()
		...
		local mysymbols = { ERROR = " ", WARN = " ", HINT = "󰠠 ", INFO = " " }
		...
		local severity = vim.diagnostic.severity
		for level, icon in pairs(mysymbols) do
			local hl = "DiagnosticSign" .. level
			signs.text[severity[level]] = icon
			signs.linehl[severity[level]] = hl
			signs.numhl[severity[level]] = ""
		end
